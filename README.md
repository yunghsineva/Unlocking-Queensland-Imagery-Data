...
![image](https://github.com/user-attachments/assets/66aa547a-fd0f-4a81-8b15-d490334c22db)
...
Additionally, I explored the use of the Segment Anything Model (SAM) as an additional segmentation method. Although the results were inconsistent and it was not integrated into the final production pipeline, it is documented in Notebook 4 as an optional module for future research and experimentation.
